...
class Experiment2:
    ...
    def add_gate_passed(self):
        self.no_gates_passed += 1

    def add_traj_step(self, traj_step: np.ndarray):
        self.traj_step.append(traj_step)
    ...
    def get_traj_pos(self):
        return np.array([traj_step[[0, 3, 6]] for traj_step in self.traj_step])

    def get_traj_vel(self):
        return np.array([traj_step[[1, 4, 7]] for traj_step in self.traj_step])
    
    def get_traj_acc(self):
        return np.array([traj_step[[2, 5, 8]] for traj_step in self.traj_step])
    
    def get_traj_time(self):
        return np.array([traj_step[9] for traj_step in self.traj_step])
...
class ExperimentTracker2:
    def __init__(self):
        self.experiments = []
    
    def add_experiment(self):
        self.experiments.append(Experiment2())
    
    def add_gate_passed(self):
        self.experiments[-1].add_gate_passed()
    
    def add_traj_step(self, traj_step: np.ndarray, time_step):
        self.experiments[-1].add_traj_step(traj_step)
    ...
    def plot_last_experiment(self):
        self.experiments[-1].plot_experiment()
